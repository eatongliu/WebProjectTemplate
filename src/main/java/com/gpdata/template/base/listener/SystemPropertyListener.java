package com.gpdata.template.base.listener;
...
public class SystemPropertyListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        String templateProjectRoot = servletContext.getRealPath("/");
        //System.setProperty("template.project.root", templateProjectRoot);

        LOGGER.debug("添加配置: template.project.root = {}", templateProjectRoot);
        ConfigUtil.setConfig("template.project.root", templateProjectRoot);
